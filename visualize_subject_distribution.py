...
axes[0].tick_params(axis='both', labelsize=14, width=0.8, color='gray')

axes[0].text(0.95, 0.8, f'Mean: {df["Age"].mean():.2f}\nMedian: {df["Age"].median():.2f}\nStd Dev: {df["Age"].std():.2f}', 
             transform=axes[0].transAxes, fontsize=12, ha='right', bbox=dict(boxstyle="round,pad=0.3", edgecolor='gray', facecolor='white'))
...
axes[1].tick_params(axis='both', labelsize=14, width=0.8, color='gray')
axes[1].text(0.05, 0.8, f'Mean: {df["Height"].mean():.2f}\nMedian: {df["Height"].median():.2f}\nStd Dev: {df["Height"].std():.2f}', 
             transform=axes[1].transAxes, fontsize=12, ha='left', bbox=dict(boxstyle="round,pad=0.3", edgecolor='gray', facecolor='white'))
...
axes[2].tick_params(axis='both', labelsize=14, width=0.8, color='gray')
axes[2].text(0.95, 0.8, f'Mean: {df["Mass"].mean():.2f}\nMedian: {df["Mass"].median():.2f}\nStd Dev: {df["Mass"].std():.2f}', 
             transform=axes[2].transAxes, fontsize=12, ha='right', bbox=dict(boxstyle="round,pad=0.3", edgecolor='gray', facecolor='white'))
